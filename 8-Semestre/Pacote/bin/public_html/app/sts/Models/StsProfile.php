...
class StsProfile
{
    ...
    public function getProfile()
    {
        ...
        $pdoSelect->fullRead(
            ...
            LEFT JOIN sts_telefone_usuario AS telefone ON telefone.fk_id_usuario = usuario.id_usuario 
            LEFT JOIN sts_endereco_usuario AS endereco ON endereco.id_endereco_usuario = usuario.id_usuario 
            LEFT JOIN sts_veiculo_usuario AS veiculo ON veiculo.id_veiculo_usuario = usuario.id_usuario 
